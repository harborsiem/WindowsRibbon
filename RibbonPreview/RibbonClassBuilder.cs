        ...
        public object BuildRibbonClass(string className, string commandName, uint cmd)
        {
            ...
            switch (className)
            {
                case "RibbonQuickAccessToolbar":
                    control = Activator.CreateInstance(typeof(RibbonQuickAccessToolbar), new object[] { ribbon, cmd });
                ...
                case "RibbonApplicationMenu":
                    control = Activator.CreateInstance(typeof(RibbonApplicationMenu), new object[] { ribbon, cmd });
                ...
                case "RibbonButton":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonButton), new object[] { ribbon, cmd });
                    Buttons.Add(commandName, (RibbonButton)control);
                    break;
                case "RibbonCheckBox":
                    if (CheckBoxes == null)
                        CheckBoxes = new Dictionary<string, RibbonCheckBox>();
                    control = Activator.CreateInstance(typeof(RibbonCheckBox), new object[] { ribbon, cmd });
                    CheckBoxes.Add(commandName, (RibbonCheckBox)control);
                    break;
                case "RibbonComboBox":
                    if (ComboBoxes == null)
                        ComboBoxes = new Dictionary<string, RibbonComboBox>();
                    control = Activator.CreateInstance(typeof(RibbonComboBox), new object[] { ribbon, cmd });
                ...
                case "RibbonDropDownButton":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonDropDownButton), new object[] { ribbon, cmd });
                ...
                case "RibbonDropDownColorPicker":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonDropDownColorPicker), new object[] { ribbon, cmd });
                ...
                case "RibbonDropDownGallery":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonDropDownGallery), new object[] { ribbon, cmd });
                ...
                case "RibbonFontControl":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonFontControl), new object[] { ribbon, cmd });
                    FontControls.Add(commandName, (RibbonFontControl)control);
                    break;
                case "RibbonGroup":
                    if (Groups == null)
                        Groups = new Dictionary<string, RibbonGroup>();
                    control = Activator.CreateInstance(typeof(RibbonGroup), new object[] { ribbon, cmd });
                    Groups.Add(commandName, (RibbonGroup)control);
                    break;
                case "RibbonHelpButton":
                    control = Activator.CreateInstance(typeof(RibbonHelpButton), new object[] { ribbon, cmd });
                ...
                case "RibbonInRibbonGallery":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonInRibbonGallery), new object[] { ribbon, cmd });
                ...
                case "RibbonMenuGroup":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonMenuGroup), new object[] { ribbon, cmd });
                ...
                case "RibbonRecentItems":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonRecentItems), new object[] { ribbon, cmd });
                    RecentItems.Add(commandName, (RibbonRecentItems)control);
                    break;
                case "RibbonSpinner":
                    if (Spinners == null)
                        Spinners = new Dictionary<string, RibbonSpinner>();
                    control = Activator.CreateInstance(typeof(RibbonSpinner), new object[] { ribbon, cmd });
                    Spinners.Add(commandName, (RibbonSpinner)control);
                    break;
                case "RibbonSplitButton":
                    if (SplitButtons == null)
                        SplitButtons = new Dictionary<string, RibbonSplitButton>();
                    control = Activator.CreateInstance(typeof(RibbonSplitButton), new object[] { ribbon, cmd });
                ...
                case "RibbonSplitButtonGallery":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonSplitButtonGallery), new object[] { ribbon, cmd });
                    SplitButtonGalleries.Add(commandName, (RibbonSplitButtonGallery)control);
                    break;
                case "RibbonTab":
                    if (Tabs == null)
                        Tabs = new Dictionary<string, RibbonTab>();
                    control = Activator.CreateInstance(typeof(RibbonTab), new object[] { ribbon, cmd });
                    Tabs.Add(commandName, (RibbonTab)control);
                    break;
                case "RibbonTabGroup":
                    if (TabGroups == null)
                        TabGroups = new Dictionary<string, RibbonTabGroup>();
                    control = Activator.CreateInstance(typeof(RibbonTabGroup), new object[] { ribbon, cmd });
                ...
                case "RibbonToggleButton":
                    ...
                    control = Activator.CreateInstance(typeof(RibbonToggleButton), new object[] { ribbon, cmd });
